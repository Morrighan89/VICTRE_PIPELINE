...
"
 ...
 #   1* )
        ...
        (cd ./Victre/generation/build && cmake -DCMAKE_CXX_STANDARD=14 ..)
 ...
 #   3* )     
        ...
        (cd ./Victre/breastMass/build && cmake -DCMAKE_CXX_STANDARD=14 ..)
...
#        case $a in
 ...
 #           5* )  ;;
 #       esac
        GPU_OPTIONS="-gencode=arch=compute_80,code=sm_80"
        printf "\n\n"
...
#            * ) echo "No answer";;
#        esac
        ( cd ./Victre/projection && nvcc MC-GPU_v1.5b.cu -o MC-GPU_v1.5b.x -m64 -O2 -DUSING_MPI -I. -I$CUDA_INC -I$CUDA_SAMPLES -I $MPI_INCLUDE -lmpi -lz --ptxas-options=-v $GPU_OPTIONS )
#    ;;
